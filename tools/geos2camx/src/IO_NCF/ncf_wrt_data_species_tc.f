c**** NCF_WRT_DATA_SPECIES_TC
c
      subroutine ncf_wrt_data_species_tc(ierr,action,iounit,this_hour,
     &            num_cols,num_rows,num_lays_in,num_lays_out,nspcs,
     &                                     spec_name,height,conctc)
      implicit none
c
c-----------------------------------------------------------------------
c    Description:
...
c           conctc       R grdded array of concentrations
c       Outputs:
c           ierr         I error code
c
c-----------------------------------------------------------------------
...
c
      ...
      real          conctc(num_cols,num_rows,nspcs)
c
c-----------------------------------------------------------------------
...
c
         do j=1,num_rows
           do i=1,num_cols
             array_3d(i,j,1) = conctc(i,j,ispc)
           enddo
         enddo
c
